...
> **R:** Porque el archivo .i esta en C puro y tiene las macros extendidas
...
> **R:** porque el archivo .i no tiene comentarios, es por eso que es igual a 0.
...
> **R:** Hacen la funcion Sumar traducido en lenguaje ensamblador
...
> **R:** Porque esta definido en ese archivo
...
> **R:** me aparece un warning que el editor no soporta ese texto de codigo
...
> **R:** La macro funcion es basicamente buscar y reemplazar el texto en el codigo fuente antes que el compilador empiece a analizar la logica; "desaparece" en el preprocesamiento  y no tiene verificacion de tipos por lo que puede causar muchos errores. Por otro lado, una funcion real es un bloque independiente con su propia direccion de memoria; "desaparece" cuando termina de ejecutarse y si tiene verificacion de tipos, por lo que si le pasas algo incompatible ejemplo sumar(a,b) en donde a o b es diferente a cualquier tipo de dato en donde estan los numeros, el compilador te va a frenar con un error.
...
> **R:**  T(text), represanta codigo ejecutable y D(data), representa a los datos inicializados
